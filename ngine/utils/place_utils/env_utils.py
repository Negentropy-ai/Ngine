...
import ngine.utils.math_utils.transform_utils.numpy_impl as T
import ngine.utils.object_utils as OU
from ngine.engine.scenes.kitchen.kitchen import Scene
from ngine.engine.tasks.base import TaskBase
from ngine.utils.env import ExecuteMode
from ngine.utils.errors import SamplingError
from ngine.utils.isaaclab_utils import update_sensors
from ngine.utils.log_utils import get_default_logger
from ngine.utils.place_utils.kitchen_objects import OBJECT_INFO_CACHE
from ngine.utils.place_utils.kitchen_object_utils import extract_failed_object_name, recreate_object, clear_obj_cache
from ngine.utils.place_utils.placement_samplers import SequentialCompositeSampler, UniformRandomSampler
from ngine.utils.usd_utils import OpenUsd
...
def get_current_layout_stool_rotations(scene: Scene):
    """
    ...
    """
    root_prim = scene.arena.stage.GetPseudoRoot()
...
def get_island_group_counter_names(scene: Scene):
    """
...
def get_combined_counters_2d_bbox_corners(task: TaskBase, counter_names):
    """
...
def compute_robot_base_placement_pose(scene: Scene, task: TaskBase, ref_fixture, ref_object=None, offset=None):
    """
    steps:
    ...
    """
    from ngine.engine.models.fixtures import (
        Counter,
        Stove,
        Stovetop,
        HousingCabinet,
...
def _get_placement_initializer(orchestrator, cfg_list, seed, z_offset=0.01) -> SequentialCompositeSampler:
    ...
    from ngine.engine.models.fixtures import FixtureType, fixture_is_type
...
def create_obj(task: TaskBase, cfg: Dict[str, Any], version=None, ignore_cache=False):
    """
    ...
    from ngine.utils.place_utils.kitchen_object_utils import sample_kitchen_object
