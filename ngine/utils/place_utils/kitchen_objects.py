...
OBJ_CATEGORIES = postprocess_categories(get_loader().list_registry(), selected_type="objects")
FIXTURE_CATEGORIES = postprocess_categories(get_loader().list_registry(), selected_type="fixtures")
