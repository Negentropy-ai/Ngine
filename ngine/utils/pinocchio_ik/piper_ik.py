...
def _default_urdf_path() -> Tuple[str, list[str]]:
    ...
    # This file: ngine/utils/pinocchio_ik/piper_ik.py
    cur_dir = os.path.dirname(os.path.abspath(__file__))
    ngine_dir = os.path.dirname(os.path.dirname(cur_dir))
    # utils/piper_description/urdf/piper_description.urdf
    urdf_dir = os.path.join(ngine_dir, "utils", "piper_description", "urdf")
    ...
    package_dirs = [os.path.join(ngine_dir, "utils")]
