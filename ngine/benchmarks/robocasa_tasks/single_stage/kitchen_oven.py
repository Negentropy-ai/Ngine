...
from ngine.engine.models import fixtures
from ngine.engine.models.fixtures import FixtureType
from ngine.engine.models.fixtures.others import Floor, Wall
from ngine.engine.tasks.base import TaskBase


class PreheatOven(TaskBase):
