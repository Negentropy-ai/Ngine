...
from ngine.engine.models.fixtures import fixture_is_type
from ngine.engine.models.fixtures import FixtureType
from ngine.engine.models.fixtures import HingeCabinet, FridgeFrenchDoor, FridgeBottomFreezer, Drawer, Counter, Stove, Stovetop, HousingCabinet, SingleCabinet, Fridge, Wall, Floor
from ngine.engine.scenes.kitchen.kitchen import Scene
from ngine.engine.tasks.base import TaskBase


class ManipulateDoor(TaskBase):
    """
    ...
    def _place_robot(self, scene: Scene):
        pass
...
class OpenOven(OpenDropDownDoor):
    ...
    EXCLUDE_LAYOUTS = TaskBase.OVEN_EXCLUDED_LAYOUTS
...
class OpenToasterOvenDoor(TaskBase):
    """
...
class CloseToasterOvenDoor(TaskBase):
    """
    Class encapsulating the atomic toaster oven door tasks.
