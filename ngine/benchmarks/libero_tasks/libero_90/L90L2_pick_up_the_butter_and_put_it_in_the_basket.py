...
from ngine.benchmarks.libero_tasks.base.libero_put_object_in_basket_base import PutObjectInBasketBase


class L90L2PickUpTheButterAndPutItInTheBasket(TaskBase):
