...
from ngine.utils.video_recorder import VideoProcessor, calculate_camera_layout, get_video_duration
...
def main():
    ...
    from ngine.utils.place_utils.env_utils import set_camera_follow_pose
