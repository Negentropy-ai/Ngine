...
from ngine.utils.lerobot_common import common
...
def get_logger(args):
    writer = SummaryWriter(f"ngine_logs/maniskill_ppo/runs/{args.exp_name}")
    writer.add_text(
        "hyperparameters",
...
class PPO():
    ...
    def save_model(self, iteration):
        model_path = f"ngine_logs/maniskill_ppo/runs/{self.args.exp_name}/ckpt_{iteration}.pt"
