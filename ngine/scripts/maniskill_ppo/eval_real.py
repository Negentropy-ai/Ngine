...
def main(args):
    ...
    from ngine.sim2real.lerobot_follower.so100_follower import SO100Follower
    from ngine.sim2real.lerobot_follower.so101_follower import SO101Follower
    ...
    if "-" in args_cli.task:
        ...
        gym.register(
            id=task_name,
            entry_point="isaaclab.envs:ManagerBasedRLEnv",  # ngine.enhance.envs:ManagerBasedRLDigitalTwinEnv
            kwargs={
            },
    ...
    from ngine.scripts.maniskill_ppo.agent import PPOArgs, PPO, observation
...
from ngine.scripts.maniskill_ppo.agent import PPOArgs
