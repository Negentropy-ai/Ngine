...
# Get project root directory (assuming script is in ngine/scripts/policy/)
...
def main(usr_args):
    ...
    from ngine.distributed.proxy import RemoteEnv
    env = RemoteEnv.make(address=('127.0.0.1', 50000), authkey=b'ngine')
    from ngine.distributed.restful import DotDict
...
if __name__ == "__main__":
    # example: "python ngine/scripts/policy/eval_policy.py --config policy/GR00T/deploy_policy_piper.yml \
