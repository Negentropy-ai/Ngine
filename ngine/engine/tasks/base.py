...
import ngine.engine.mdp as mdp
import ngine.utils.fixture_utils as FixtureUtils
import ngine.utils.math_utils.transform_utils.numpy_impl as Tn
import ngine.utils.object_utils as OU
import ngine.utils.place_utils.env_utils as EnvUtils
from ngine.engine.checks.checker_factory import get_checkers_from_cfg, form_checker_result
from ngine.engine.context import get_context
from ngine.engine.models.assets.ngine_object import NgineObject
from ngine.engine.models.fixtures import Fixture, FixtureType, fixture_is_type
from ngine.engine.models.scenes.scene_parser import register_fixture_from_obj
from ngine.utils.csv_loader import csv_loader
from ngine.utils.env import ExecuteMode
from ngine.utils.isaaclab_utils import NoDeepcopyMixin
from ngine.utils.log_utils import copy_dict_for_json
from ngine.utils.place_utils.contact_queue import ContactQueue
from ngine.utils.place_utils.usd_object import USDObject
...
class TaskBase(TaskBase, NoDeepcopyMixin):
    task_name: str = None
    ...
    def get_ep_meta(self):
        ...
        ep_meta["LW_API_ENDPOINT"] = get_loader().host
        return ep_meta
