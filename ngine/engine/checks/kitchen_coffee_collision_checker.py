...
from ngine.engine.checks.base_checker import BaseChecker
from ngine.engine.models.fixtures.fixture_types import FixtureType
from ngine.utils.object_utils import check_contact
