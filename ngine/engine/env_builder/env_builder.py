...
from ngine.engine.rl.base import RLConfig


class EnvBuilder(ArenaEnvBuilder):

    DEFAULT_SCENE_CFG = InteractiveSceneCfg(num_envs=4096, env_spacing=30.0)

    def __init__(self, arena_env: IsaacLabArenaEnvironment, args: argparse.Namespace, rl_env: RLConfig):
