...
from ngine.engine.embodiments.compositional.assets_cfg import FRANKA_OMRON_HIGH_PD_CFG, OFFSET_CONFIG, VIS_HELPER_CFG  # isort: skip
...
class PandaOmronEmbodiment(RobotBase):
