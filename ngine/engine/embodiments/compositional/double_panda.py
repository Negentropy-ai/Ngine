...
from ngine.engine.embodiments.robot_arena_base import EmbodimentBaseObservationCfg, EmbodimentBasePolicyObservationCfg, RobotBase
...
class DoublePandaEnvCfg(RobotBase):
