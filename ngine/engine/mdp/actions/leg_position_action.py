...
from ngine.engine.mdp.actions.controller import Controller_loco, Controller_squat
from ngine.engine.mdp.config import Config
from ngine.engine.mdp.helpers.KF import IMUKF
from ngine.engine.mdp.helpers.rotation_helper import get_gravity_orientation
...
class LegPositionAction(ActionTerm):
    ...
    def __init__(self, cfg: "LegPositionActionCfg", env: ManagerBasedEnv):
        ...
        loco_config_path = f"ngine/engine/mdp/configs/{cfg.loco_config}"
        self.loco_config = Config(loco_config_path)
        squat_config_path = f"ngine/engine/mdp/configs/{cfg.squat_config}"
